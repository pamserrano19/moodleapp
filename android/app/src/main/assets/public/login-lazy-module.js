...
const routes = [
    ...
    {
        path: 'site',
        loadChildren: () => Promise.all(/*! import() | pages-site-site-module */[__webpack_require__.e("default~addons-blog-blog-lazy-module~addons-calendar-pages-index-index-module~features-tag-pages-sea~c9aa5c58"), __webpack_require__.e("pages-site-site-module")]).then(__webpack_require__.bind(null, /*! ./pages/site/site.module */ "./src/core/features/login/pages/site/site.module.ts")).then(m => m.CoreLoginSitePageModule),
    },
    {
        path: 'credentials',
