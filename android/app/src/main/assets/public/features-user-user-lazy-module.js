...
const routes = [
    ...
    {
        path: 'profile',
        loadChildren: () => Promise.all(/*! import() | pages-profile-profile-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-profile-profile-module")]).then(__webpack_require__.bind(null, /*! ./pages/profile/profile.module */ "./src/core/features/user/pages/profile/profile.module.ts")).then(m => m.CoreUserProfilePageModule),
    },
    {
        path: 'about',
