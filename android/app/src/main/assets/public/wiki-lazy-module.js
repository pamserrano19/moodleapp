...
let AddonModWikiEditPage = class AddonModWikiEditPage {
    ...
    fetchModuleAndCourseId() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const module = yield _features_course_services_course__WEBPACK_IMPORTED_MODULE_4__["CoreCourse"].getModuleBasicInfoByInstance(this.wikiId, 'wiki', { readingStrategy: 1 /* PREFER_CACHE */ });
            this.cmId = module.id;
