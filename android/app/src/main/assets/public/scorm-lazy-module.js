    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                this.siteId = _services_sites__WEBPACK_IMPORTED_MODULE_4__["CoreSites"].getRequiredCurrentSite().getId();
            }
            catch (error) {
            ...
            try {
                ...
                if (this.newAttempt) {
                    try {
                        ...
                        _services_utils_dom__WEBPACK_IMPORTED_MODULE_6__["CoreDomUtils"].showErrorModalDefault(error, 'addon.mod_scorm.errorgetscorm', true);
                    }
                }
                // Load SCO.
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.launchNextObserver = _singletons_events__WEBPACK_IMPORTED_MODULE_9__["CoreEvents"].on(_services_scorm__WEBPACK_IMPORTED_MODULE_12__["AddonModScormProvider"].LAUNCH_NEXT_SCO_EVENT, (data) => {
                if (data.scormId === this.scorm.id && this.currentSco) {
                    const nextSco = _services_scorm_helper__WEBPACK_IMPORTED_MODULE_13__["AddonModScormHelper"].getNextScoFromToc(this.toc, this.currentSco.id);
                    if (nextSco) {
            ...
            this.launchPrevObserver = _singletons_events__WEBPACK_IMPORTED_MODULE_9__["CoreEvents"].on(_services_scorm__WEBPACK_IMPORTED_MODULE_12__["AddonModScormProvider"].LAUNCH_PREV_SCO_EVENT, (data) => {
                if (data.scormId === this.scorm.id && this.currentSco) {
                    const previousSco = _services_scorm_helper__WEBPACK_IMPORTED_MODULE_13__["AddonModScormHelper"].getPreviousScoFromToc(this.toc, this.currentSco.id);
                    if (previousSco) {
