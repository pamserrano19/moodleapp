...
let AddonModWorkshopAssessmentPage = class AddonModWorkshopAssessmentPage {
    ...
    ngOnInit() {
        try {
            this.assessment = _services_navigator__WEBPACK_IMPORTED_MODULE_6__["CoreNavigator"].getRequiredRouteParam('assessment');
            this.submission = _services_navigator__WEBPACK_IMPORTED_MODULE_6__["CoreNavigator"].getRequiredRouteParam('submission');
            this.profile = _services_navigator__WEBPACK_IMPORTED_MODULE_6__["CoreNavigator"].getRequiredRouteParam('profile');
...
/* harmony import */ var _services_workshop__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../services/workshop */ "./src/addons/mod/workshop/services/workshop.ts");
/* harmony import */ var _services_workshop_helper__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../services/workshop-helper */ "./src/addons/mod/workshop/services/workshop-helper.ts");
/* harmony import */ var _services_workshop_offline__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../services/workshop-offline */ "./src/addons/mod/workshop/services/workshop-offline.ts");
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
let AddonModWorkshopEditSubmissionPage = class AddonModWorkshopEditSubmissionPage {
    constructor(fb) {
        this.fb = fb;
        this.loaded = false;
        this.component = _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshopProvider"].COMPONENT;
    ...
    ngOnInit() {
        try {
            this.module = _services_navigator__WEBPACK_IMPORTED_MODULE_7__["CoreNavigator"].getRequiredRouteParam('module');
            this.courseId = _services_navigator__WEBPACK_IMPORTED_MODULE_7__["CoreNavigator"].getRequiredRouteNumberParam('courseId');
            this.access = _services_navigator__WEBPACK_IMPORTED_MODULE_7__["CoreNavigator"].getRequiredRouteParam('access');
    ...
    canLeave() {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            _singletons_form__WEBPACK_IMPORTED_MODULE_15__["CoreForms"].triggerFormCancelledEvent(this.formElement, this.siteId);
            return true;
        });
    }
    /**
    ...
    fetchSubmissionData() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                this.workshop = yield _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshop"].getWorkshop(this.courseId, this.module.id);
                this.textAvailable = (this.workshop.submissiontypetext != _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshopSubmissionType"].SUBMISSION_TYPE_DISABLED);
                this.textRequired = (this.workshop.submissiontypetext == _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshopSubmissionType"].SUBMISSION_TYPE_REQUIRED);
                this.fileAvailable = (this.workshop.submissiontypefile != _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshopSubmissionType"].SUBMISSION_TYPE_DISABLED);
                this.fileRequired = (this.workshop.submissiontypefile == _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshopSubmissionType"].SUBMISSION_TYPE_REQUIRED);
                ...
                if (this.submissionId > 0) {
                    this.editing = true;
                    this.submission =
                        yield _services_workshop_helper__WEBPACK_IMPORTED_MODULE_17__["AddonModWorkshopHelper"].getSubmissionById(this.workshopId, this.submissionId, { cmId: this.module.id });
                ...
                const submissionsActions = yield _services_workshop_offline__WEBPACK_IMPORTED_MODULE_18__["AddonModWorkshopOffline"].getSubmissions(this.workshopId);
                if (submissionsActions && submissionsActions.length) {
                    this.hasOffline = true;
                    this.submission = yield _services_workshop_helper__WEBPACK_IMPORTED_MODULE_17__["AddonModWorkshopHelper"].applyOfflineData(this.submission, submissionsActions);
                }
                else {
                    this.hasOffline = false;
                }
    ...
    saveSubmission() {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (!inputData.title) {
                ...
                throw new _classes_errors_error__WEBPACK_IMPORTED_MODULE_3__["CoreError"](_singletons__WEBPACK_IMPORTED_MODULE_13__["Translate"].instant('addon.mod_workshop.submissionrequiredtitle'));
            }
            ...
            if ((this.textRequired && noText) || (this.fileRequired && noFiles) || (noText && noFiles)) {
                ...
                throw new _classes_errors_error__WEBPACK_IMPORTED_MODULE_3__["CoreError"](_singletons__WEBPACK_IMPORTED_MODULE_13__["Translate"].instant('addon.mod_workshop.submissionrequiredcontent'));
            }
            ...
            try {
                ...
                try {
                    attachmentsId = yield _services_workshop_helper__WEBPACK_IMPORTED_MODULE_17__["AddonModWorkshopHelper"].uploadOrStoreSubmissionFiles(this.workshopId, inputData.attachmentfiles, false);
                }
                catch (error) {
                    ...
                    saveOffline = true;
                    allowOffline = true;
                    storeFilesResult = yield _services_workshop_helper__WEBPACK_IMPORTED_MODULE_17__["AddonModWorkshopHelper"].uploadOrStoreSubmissionFiles(this.workshopId, inputData.attachmentfiles, true);
                }
                ...
                if (this.editing) {
                    if (saveOffline) {
                        ...
                        yield _services_workshop_offline__WEBPACK_IMPORTED_MODULE_18__["AddonModWorkshopOffline"].saveSubmission(this.workshopId, this.courseId, inputData.title, inputData.content, storeFilesResult, submissionId, _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshopAction"].UPDATE);
                        newSubmissionId = false;
                    }
                    else {
                        // Try to send it to server.
                        // Don't allow offline if there are attachments since they were uploaded fine.
                        newSubmissionId = yield _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshop"].updateSubmission(this.workshopId, submissionId, this.courseId, inputData.title, inputData.content, attachmentsId, undefined, allowOffline);
                    }
                }
                else {
                    if (saveOffline) {
                        // Save submission in offline.
                        yield _services_workshop_offline__WEBPACK_IMPORTED_MODULE_18__["AddonModWorkshopOffline"].saveSubmission(this.workshopId, this.courseId, inputData.title, inputData.content, storeFilesResult, undefined, _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshopAction"].ADD);
                        newSubmissionId = false;
                    }
                    else {
                        // Try to send it to server.
                        // Don't allow offline if there are attachments since they were uploaded fine.
                        newSubmissionId = yield _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshop"].addSubmission(this.workshopId, this.courseId, inputData.title, inputData.content, attachmentsId, undefined, allowOffline);
                    }
                }
                _singletons_form__WEBPACK_IMPORTED_MODULE_15__["CoreForms"].triggerFormSubmittedEvent(this.formElement, !!newSubmissionId, this.siteId);
                const data = {
                    workshopId: this.workshopId,
                };
                if (newSubmissionId) {
                    // Data sent to server, delete stored files (if any).
                    _services_workshop_offline__WEBPACK_IMPORTED_MODULE_18__["AddonModWorkshopOffline"].deleteSubmissionAction(this.workshopId, this.editing ? _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshopAction"].UPDATE : _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshopAction"].ADD);
                    _services_workshop_helper__WEBPACK_IMPORTED_MODULE_17__["AddonModWorkshopHelper"].deleteSubmissionStoredFiles(this.workshopId, this.siteId);
                    data.submissionId = newSubmissionId;
                }
                _singletons_events__WEBPACK_IMPORTED_MODULE_14__["CoreEvents"].trigger(_singletons_events__WEBPACK_IMPORTED_MODULE_14__["CoreEvents"].ACTIVITY_DATA_SENT, { module: 'workshop' });
                const promise = newSubmissionId ? _services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshop"].invalidateSubmissionData(this.workshopId, newSubmissionId) :
                    Promise.resolve();
                yield promise.finally(() => {
                    _singletons_events__WEBPACK_IMPORTED_MODULE_14__["CoreEvents"].trigger(_services_workshop__WEBPACK_IMPORTED_MODULE_16__["AddonModWorkshopProvider"].SUBMISSION_CHANGED, data, this.siteId);
                    // Delete the local files from the tmp folder.
